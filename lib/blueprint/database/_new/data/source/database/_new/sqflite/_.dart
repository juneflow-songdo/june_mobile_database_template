...
class NewModelSqflite {
  ...
  NewModel fromMap(Map<dynamic, dynamic> map) {
    ...
    // object.C000 = NewSubModel.fromString(map["C000"] ?? NewSubModel().toString());
    // object.C001 = NewSubModel.fromString(map['C001'] ?? NewSubModel().toString());
    // object.C002 = NewSubModel.fromString(map['C002'] ?? NewSubModel().toString());
    // object.C003 = NewSubModel.fromString(map['C003'] ?? NewSubModel().toString());
    // object.C004 = NewSubModel.fromString(map['C004'] ?? NewSubModel().toString());
    // object.C005 = NewSubModel.fromString(map['C005'] ?? NewSubModel().toString());
    // object.C006 = NewSubModel.fromString(map['C006'] ?? NewSubModel().toString());
    // object.C007 = NewSubModel.fromString(map['C007'] ?? NewSubModel().toString());
    // object.C008 = NewSubModel.fromString(map['C008'] ?? NewSubModel().toString());
    // object.C009 = NewSubModel.fromString(map['C009'] ?? NewSubModel().toString());
    // object.C010 = NewSubModel.fromString(map['C010'] ?? NewSubModel().toString());
    // object.C011 = NewSubModel.fromString(map['C011'] ?? NewSubModel().toString());
    // object.C012 = NewSubModel.fromString(map['C012'] ?? NewSubModel().toString());
    // object.C013 = NewSubModel.fromString(map['C013'] ?? NewSubModel().toString());
    // object.C014 = NewSubModel.fromString(map['C014'] ?? NewSubModel().toString());
    // object.C015 = NewSubModel.fromString(map['C015'] ?? NewSubModel().toString());
    // object.C016 = NewSubModel.fromString(map['C016'] ?? NewSubModel().toString());
    // object.C017 = NewSubModel.fromString(map['C017'] ?? NewSubModel().toString());
    // object.C018 = NewSubModel.fromString(map['C018'] ?? NewSubModel().toString());
    // object.C019 = NewSubModel.fromString(map['C019'] ?? NewSubModel().toString());
    // object.C020 = NewSubModel.fromString(map['C020'] ?? NewSubModel().toString());

    // object.J000 = (jsonDecode(map["J000"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J001 = (jsonDecode(map["J001"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J002 = (jsonDecode(map["J002"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J003 = (jsonDecode(map["J003"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J004 = (jsonDecode(map["J004"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J005 = (jsonDecode(map["J005"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J006 = (jsonDecode(map["J006"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J007 = (jsonDecode(map["J007"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J008 = (jsonDecode(map["J008"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J009 = (jsonDecode(map["J009"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J010 = (jsonDecode(map["J010"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J011 = (jsonDecode(map["J011"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J012 = (jsonDecode(map["J012"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J013 = (jsonDecode(map["J013"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J014 = (jsonDecode(map["J014"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J015 = (jsonDecode(map["J015"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J016 = (jsonDecode(map["J016"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J017 = (jsonDecode(map["J017"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    // object.J018 = (jsonDecode(map["J018"] ?? "[]") as List).map((item) => NewSubModel.fromString(item)).toList();
    ...
    // object.E003 = NewEnum.fromString(map["E003"] ?? NewEnum.NotSelected.toStringValue());
    // object.E004 = NewEnum.fromString(map["E004"] ?? NewEnum.NotSelected.toStringValue());
    // object.E005 = NewEnum.fromString(map["E005"] ?? NewEnum.NotSelected.toStringValue());
    // object.E006 = NewEnum.fromString(map["E006"] ?? NewEnum.NotSelected.toStringValue());
    // object.E007 = NewEnum.fromString(map["E007"] ?? NewEnum.NotSelected.toStringValue());
    // object.E008 = NewEnum.fromString(map["E008"] ?? NewEnum.NotSelected.toStringValue());
    // object.E009 = NewEnum.fromString(map["E009"] ?? NewEnum.NotSelected.toStringValue());
    // object.E010 = NewEnum.fromString(map["E010"] ?? NewEnum.NotSelected.toStringValue());
    // object.E011 = NewEnum.fromString(map["E011"] ?? NewEnum.NotSelected.toStringValue());
    // object.E012 = NewEnum.fromString(map["E012"] ?? NewEnum.NotSelected.toStringValue());
    // object.E013 = NewEnum.fromString(map["E013"] ?? NewEnum.NotSelected.toStringValue());
    // object.E014 = NewEnum.fromString(map["E014"] ?? NewEnum.NotSelected.toStringValue());
    // object.E015 = NewEnum.fromString(map["E015"] ?? NewEnum.NotSelected.toStringValue());
    // object.E016 = NewEnum.fromString(map["E016"] ?? NewEnum.NotSelected.toStringValue());
    // object.E017 = NewEnum.fromString(map["E017"] ?? NewEnum.NotSelected.toStringValue());
    // object.E018 = NewEnum.fromString(map["E018"] ?? NewEnum.NotSelected.toStringValue());
    // object.E019 = NewEnum.fromString(map["E019"] ?? NewEnum.NotSelected.toStringValue());
    // object.E020 = NewEnum.fromString(map["E020"] ?? NewEnum.NotSelected.toStringValue());
